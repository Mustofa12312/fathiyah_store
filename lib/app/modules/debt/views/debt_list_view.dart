...
class DebtListView extends GetView<DebtController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<DebtController>( // using GetBuilder for manual update trigger
        builder: (controller) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('Hebat! Tidak ada piutang saat ini.', style: TextStyle(color: AppTheme.textSecondary, fontSize: 16.sp)),
                ],
              ),
            );
          }
